...
# @Last Modified time: 2019-01-12 17:21:20
import os;
import wx;

from _Global import _GG;

from KlotskiViewUI import *;
...
class KlotskiViewCtr(object):
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.UI = KlotskiViewUI(parent, curPath = self.curPath, viewCtr = self, params = params);
		self.UI.initView();
